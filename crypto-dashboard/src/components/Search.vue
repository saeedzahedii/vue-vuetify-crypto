        ...
        <v-tabs-items v-model="tabs">
            <v-tab-item>
                <v-card class="mt-5 pt-3">
                    ...
                    <v-alert v-if="!this.display || this.displayCoinList.length == 0" border="right" color="blue-grey" dark>
                        No Result Yet
                    </v-alert>
                </v-card>
            </v-tab-item>
            <v-tab-item>
                <v-card class="mt-5 pt-3">
                    ...
                    <v-alert v-if="!this.display || this.exchangeList.length == 0" border="right" color="blue-grey" dark>
                        No Result Yet
                    </v-alert>
                </v-card>
            </v-tab-item>
            <v-tab-item>
                <v-card class="mt-5 pt-3">
                    ...
                    <v-alert v-if="!this.display || this.marketsList.length == 0" border="right" color="blue-grey" dark>
                        No Result Yet
                    </v-alert>
                </v-card>
            </v-tab-item>
